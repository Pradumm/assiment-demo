...
const CardItem = ({ user, RemoveUser }) => {
    ...
    return (
        <div class="flex relative items-center  gap-2">
            ...
            <div className={` ${toggleItem ? " flex  items-center flex-col sm:flex-row " : " flex-col"} bg-white px-5 py-3  shadow-sm mb-7 rounded-xl flex  items-center gap-5 `}>
                ...
                <div>
                    <h1 className='text-xl hidden sm:block font-semibold text-black'>
                ...
                <img
                    className={`${toggleItem == false ? "w-full h-48" : "hidden"}`}
            ...
            <div className={`${toggleItem == false ? "absolute right-0 top-0" : ""}   bg-white p-2 flex items-center justify-center rounded-full`}>
                <RxCross1
